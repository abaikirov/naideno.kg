...
namespace naideno.kg.Initializer
{
    public class DBInit : System.Data.Entity.DropCreateDatabaseIfModelChanges<EFDbContext>
    {
        protected override void Seed(EFDbContext context)
        {
            ...
            passports.ForEach(p => context.Passports.Add(p));
            context.SaveChanges();
            ...
            universals.ForEach(u => context.Universals.Add(u));
            context.SaveChanges();
        }
    }
}