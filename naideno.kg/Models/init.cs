        ...
        protected override void Seed(EFDbContext db)
        {
            ...
            var users = new List<User>
          {
            ...
            var passports = new List<Passport>
            {
                ...
                new Passport { ID = 7, Name = "Вий", SecondName = "Кличко", ThirdName = "Витальевич", Birthday = new DateTime(1977, 09, 12), UploadDate = new DateTime(2016, 03, 19), Category = "Пасспорт", Status = false, UserID = 5 , MatchID = "ВийКличкоВитальевичПасспорт19.03.2016"},
